...
def convert_file(fname, outputdir="outputs_29x15_tt_v1/", prefix="", suffix="", treename="tree"):
    ...
    try:
        ...
        ele_oldsigmaietaieta_, ele_oldsigmaiphiiphi_, \
            ...
            ele_isEBEtaGap, ele_isEBPhiGap, \
            ele_isEBEEGap, ele_isEEDeeGap, ele_isEERingGap = \
            t.arrays([
...
if __name__ == "__main__":
    ...
    # thedir = "/hadoop/cms/store/user/namin/elemva/ProjectMetis/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v2_MINIAODSIM_v13/"
    thedir = "/hadoop/cms/store/user/namin/elemva/ProjectMetis/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1_MINIAODSIM_v15/"
    fnames = glob.glob(thedir + "/*.root")[:40]
